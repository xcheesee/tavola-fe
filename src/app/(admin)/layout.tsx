...
export default function AdminLayout({children}: {children: React.ReactNode}) {
    return (
        <div className="grid lg:grid-cols-[200px_1fr] grid-cols-1 grid-rows-[min-content_1fr] min-h-screen">
            <div className="col-span-2 px-4 py-2 justify-between items-center flex">
            ...
            <div className="max-lg:hidden p-4 flex flex-col gap-8">
